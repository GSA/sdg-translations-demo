...
var mapView = function () {
  ...
  this.initialise = function(geoData, geoCodeRegEx) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"minZoom":6,"tileOptions":{"accessToken":"pk.eyJ1IjoiYnJvY2tmYW5uaW5nMSIsImEiOiJjaXplbmgzczgyMmRtMnZxbzlmbGJmdW9pIn0.LU-BYMX69uu3eGgk0Imibg","attribution":"<a href=\"https://www.mapbox.com\">Mapbox</a> | <a href=\"http://geoportal.statistics.gov.uk/\">ONS</a>","id":"mapbox.light"},"tileURL":"https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}"},
      mapLayers: [{"idProperty":"rgn17cd","max_zoom":6,"min_zoom":0,"nameProperty":"rgn17nm","serviceUrl":"https://opendata.arcgis.com/datasets/4fcca2a47fed4bfaa1793015a18537ac_4.geojson","staticBorders":true},{"idProperty":"lad16cd","max_zoom":20,"min_zoom":7,"nameProperty":"lad16nm","serviceUrl":"https://geoportal1-ons.opendata.arcgis.com/datasets/686603e943f948acaa13fb5d2b0f1275_4.geojson"}],
    });
  };
};
